...
def build_prompt(context, user_query):
    ...
    user_message = (
        ...
        "    2-3 sentences citing SPECIFIC numbers: e.g. 'Michigan's +8.2 home margin\n"
        "    and 4-1 home record support covering 9.5, and the line moved from -8.5 to\n"
        "    -9.5 on DraftKings suggesting sharp action on the favorite.'\n"
        "    Do NOT use vague phrases like 'strong offense' or 'recent form' without numbers.\n"
        "    Total: NO EDGE\n\n"
        "  FORMAT B — If ONLY the total has an edge:\n"
        "    RECOMMENDATION: [OVER/UNDER] [TOTAL] — [CONFIDENCE]\n"
        "    2-3 sentences citing SPECIFIC numbers: e.g. 'Expected total of 158.3 is 6.8\n"
        "    points above the posted 151.5, and the total has moved up from 149.5 to 151.5\n"
        "    at DraftKings, confirming the over lean.'\n"
        "    Do NOT use vague phrases. Every claim needs a number.\n"
        "    Spread: NO EDGE\n\n"
        "  FORMAT C — If BOTH markets have an edge, present BOTH:\n"
        "    RECOMMENDATION 1: [TEAM] [SPREAD] — [CONFIDENCE]\n"
        "    2-3 sentences with specific numbers supporting the spread edge.\n"
        "    RECOMMENDATION 2: [OVER/UNDER] [TOTAL] — [CONFIDENCE]\n"
        "    2-3 sentences with specific numbers supporting the totals edge.\n\n"
